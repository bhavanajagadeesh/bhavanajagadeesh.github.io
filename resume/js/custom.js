document.addEventListener('DOMContentLoaded', function(){
  Typed.new('.intro-text', {
    strings: ["^600 Bhavana jagadeesh.", "^600 a Front end Developer.", "^1000 a Shopify Expert.", "^600 a Woocommerce Developer."],
    typeSpeed: 0,
    startDelay: 1000,
    loop: true
  });
...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(10.037148, 76.3199903), // New York
